...
/**
 * linyun, copy this class from CheckedTreeSelectionDialog, and find its bug
 * in create method. The bug is the order of creating checking and expanding
 * tree should be reversed.
 * 
 * @since 2.0
 */
