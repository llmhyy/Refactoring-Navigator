 ...
 * @generated
 */
public class ReflexactoringNavigatorActionProvider extends CommonActionProvider {
	...
	private static class OpenDiagramAction extends Action {
		...
		public final void selectionChanged(IStructuredSelection selection) {
			...
			if (selection.size() == 1) {
				...
				if (selectedElement instanceof ReflexactoringNavigatorItem) {
					selectedElement = ((ReflexactoringNavigatorItem) selectedElement)
							.getView();
		...
		public void run() {
			...
			try {
				page.openEditor(editorInput, ReflexactoringDiagramEditor.ID);
