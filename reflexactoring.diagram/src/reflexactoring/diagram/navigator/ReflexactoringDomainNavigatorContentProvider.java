 ...
 * @generated
 */
public class ReflexactoringDomainNavigatorContentProvider implements
	 ...
	 * @generated
	 */
	public ReflexactoringDomainNavigatorContentProvider() {
	...
	public Object[] getChildren(Object parentElement) {
		...
		if (parentElement instanceof ReflexactoringDomainNavigatorItem) {
			return wrapEObjects(
					myAdapterFctoryContentProvier.getChildren(((ReflexactoringDomainNavigatorItem) parentElement)
	...
	public Object[] wrapEObjects(Object[] objects, Object parentElement) {
		...
		for (int i = 0; i < objects.length; i++) {
			if (objects[i] instanceof EObject) {
				result.add(new ReflexactoringDomainNavigatorItem(
