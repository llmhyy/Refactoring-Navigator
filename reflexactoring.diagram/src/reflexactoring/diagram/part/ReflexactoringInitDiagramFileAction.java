 ...
 * @generated
 */
public class ReflexactoringInitDiagramFileAction implements
	...
	public void run(IAction action) {
		...
		Wizard wizard = new ReflexactoringNewDiagramFileWizard(domainModelURI,
				diagramRoot, editingDomain);
		wizard.setWindowTitle(NLS.bind(Messages.InitDiagramFile_WizardTitle,
				ReflexactoringEditPart.MODEL_ID));
		ReflexactoringDiagramEditorUtil.runWizard(getShell(), wizard,
