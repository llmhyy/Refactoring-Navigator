...
public class CreationConstraintConfidenceView extends ViewPart {

	private TableViewer tableViewer;
	private Composite composite;
	
	public CreationConstraintConfidenceView() {
	...
	public void createPartControl(Composite parent) {
		...
		item.addSelectionListener(new SelectionListener() {
			...
			public void widgetSelected(SelectionEvent e) {
				if(tableViewer != null){
					tableViewer.setInput(Settings.creationConfidenceTable);;
					tableViewer.refresh();					
				}
				else{
		...
		if (Settings.creationConfidenceTable != null
				&& Settings.creationConfidenceTable.size() > 0) {
			refreshUI(Settings.creationConfidenceTable);
		}
	 ...
	 */
	public void refreshUI(ModuleCreationConfidenceTable confidenceTable) {
	...
	private void createColumns(final Composite parent, final TableViewer viewer) {
		...
		String[] titles = new String[Settings.creationConfidenceTable.getColumnNumber() + 1];
		int[] bounds = new int[Settings.creationConfidenceTable.getColumnNumber() + 1];
		titles[0] = "Confidence";
		bounds[0] = 100;
		ModuleCreationConfidence confidendenceList = Settings.creationConfidenceTable
				.get(0);
		...
		col.setLabelProvider(new ColumnLabelProvider() {
			...
			public String getText(Object element) {
				ModuleCreationConfidence confidence = (ModuleCreationConfidence) element;
	...
	public class TableEditingSupport extends EditingSupport {
		...
		protected Object getValue(Object element) {
			if (element instanceof ModuleCreationConfidence) {
				ModuleCreationConfidence confidence = (ModuleCreationConfidence) element;
