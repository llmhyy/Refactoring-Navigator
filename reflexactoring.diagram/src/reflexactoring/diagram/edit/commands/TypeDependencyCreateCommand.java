 ...
 * @generated
 */
public class TypeDependencyCreateCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public TypeDependencyCreateCommand(CreateRelationshipRequest request,
	...
	public boolean canExecute() {
		...
		return ReflexactoringBaseItemSemanticEditPolicy.getLinkConstraints()
				.canCreateTypeDependency_4003(getContainer(), getSource(),
						getTarget());
	}
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
		...
		TypeDependency newElement = ReflexactoringFactory.eINSTANCE
				.createTypeDependency();
		getContainer().getTypeDependencies().add(newElement);
	 ...
	 * @generated
	 */
	protected void doConfigure(TypeDependency newElement,
