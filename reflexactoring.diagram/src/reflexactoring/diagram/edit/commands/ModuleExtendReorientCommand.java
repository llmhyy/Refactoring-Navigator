 ...
 * @generated
 */
public class ModuleExtendReorientCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public ModuleExtendReorientCommand(ReorientRelationshipRequest request) {
	...
	public boolean canExecute() {
		if (false == getElementToEdit() instanceof ModuleExtend) {
			return false;
		}
	...
	protected boolean canReorientSource() {
		...
		return ReflexactoringBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistModuleExtend_4006(container, getLink(),
						getNewSource(), target);
	}
	...
	protected boolean canReorientTarget() {
		...
		Reflexactoring container = (Reflexactoring) getLink().eContainer();
		return ReflexactoringBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistModuleExtend_4006(container, getLink(), source,
						getNewTarget());
	}
	 ...
	 * @generated
	 */
	protected ModuleExtend getLink() {
		return (ModuleExtend) getElementToEdit();
	}
