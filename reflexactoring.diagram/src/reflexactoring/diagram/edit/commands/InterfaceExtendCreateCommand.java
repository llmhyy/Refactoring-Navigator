 ...
 * @generated
 */
public class InterfaceExtendCreateCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	private final Reflexactoring container;

	/**
	 * @generated
	 */
	public InterfaceExtendCreateCommand(CreateRelationshipRequest request,
	...
	public boolean canExecute() {
		...
		return ReflexactoringBaseItemSemanticEditPolicy.getLinkConstraints()
				.canCreateInterfaceExtend_4004(getContainer(), getSource(),
						getTarget());
	}
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
		...
		InterfaceExtend newElement = ReflexactoringFactory.eINSTANCE
				.createInterfaceExtend();
		getContainer().getInterfaceExtends().add(newElement);
		newElement.setSubInterface(getSource());
		newElement.setSuperInterface(getTarget());
	 ...
	 * @generated
	 */
	protected void doConfigure(InterfaceExtend newElement,
	 ...
	 * @generated
	 */
	public Reflexactoring getContainer() {
		return container;
	}
	 ...
	 * @generated
	 */
	private static Reflexactoring deduceContainer(EObject source, EObject target) {
