...
import reflexactoring.diagram.edit.commands.ModuleCreateCommand;
import reflexactoring.diagram.providers.ReflexactoringElementTypes;

/**
 * @generated
 */
public class ReflexactoringItemSemanticEditPolicy extends
		ReflexactoringBaseItemSemanticEditPolicy {

	/**
	 * @generated
	 */
	public ReflexactoringItemSemanticEditPolicy() {
		super(ReflexactoringElementTypes.Reflexactoring_1000);
	}
	...
	protected Command getCreateCommand(CreateElementRequest req) {
		if (ReflexactoringElementTypes.Class_2001 == req.getElementType()) {
			return getGEFWrapper(new ClassCreateCommand(req));
		}
		if (ReflexactoringElementTypes.Interface_2002 == req.getElementType()) {
			return getGEFWrapper(new InterfaceCreateCommand(req));
		}
		if (ReflexactoringElementTypes.Module_2003 == req.getElementType()) {
