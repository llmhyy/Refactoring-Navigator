...
import reflexactoring.diagram.edit.policies.InterfaceItemSemanticEditPolicy;
...
public class InterfaceEditPart extends ShapeNodeEditPart {
	...
	public List<IElementType> getMARelTypesOnSourceAndTarget(
		...
		if (targetEditPart instanceof reflexactoring.diagram.edit.parts.InterfaceEditPart) {
			types.add(ReflexactoringElementTypes.TypeDependency_4003);
		}
