...
import reflexactoring.diagram.edit.policies.ClassItemSemanticEditPolicy;
...
public class ClassEditPart extends ShapeNodeEditPart {
	...
	public List<IElementType> getMARelTypesOnSource() {
		...
		types.add(ReflexactoringElementTypes.ClassExtend_4002);
	...
	public List<IElementType> getMARelTypesOnSourceAndTarget(
		...
		if (targetEditPart instanceof reflexactoring.diagram.edit.parts.ClassEditPart) {
			types.add(ReflexactoringElementTypes.ClassExtend_4002);
		}
	...
	public List<IElementType> getMATypesForTarget(IElementType relationshipType) {
		LinkedList<IElementType> types = new LinkedList<IElementType>();
		if (relationshipType == ReflexactoringElementTypes.ClassExtend_4002) {
			types.add(ReflexactoringElementTypes.Class_2001);
			types.add(ReflexactoringElementTypes.Class_3001);
		} else if (relationshipType == ReflexactoringElementTypes.TypeDependency_4003) {
			types.add(ReflexactoringElementTypes.Class_2001);
	 ...
	 * @generated
	 */
	static final Color THIS_BACK = new Color(null, 166, 219, 153);
