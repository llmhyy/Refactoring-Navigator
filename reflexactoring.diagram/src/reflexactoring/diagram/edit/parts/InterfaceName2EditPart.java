...
import reflexactoring.diagram.edit.policies.ReflexactoringTextSelectionEditPolicy;
...
public class InterfaceName2EditPart extends CompartmentEditPart implements
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.SELECTION_FEEDBACK_ROLE,
				new ReflexactoringTextSelectionEditPolicy());
		installEditPolicy(EditPolicy.DIRECT_EDIT_ROLE,
				new LabelDirectEditPolicy());
		installEditPolicy(EditPolicy.PRIMARY_DRAG_ROLE,
				new ReflexactoringEditPart.NodeLabelDragPolicy());
	}
	...
	protected Image getLabelIcon() {
		...
		return ReflexactoringElementTypes.getImage(parserElement.eClass());
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = ReflexactoringParserProvider
					.getParser(
							ReflexactoringElementTypes.Interface_3002,
							getParserElement(),
							ReflexactoringVisualIDRegistry
									.getType(reflexactoring.diagram.edit.parts.InterfaceName2EditPart.VISUAL_ID));
		}
		return parser;
	}
