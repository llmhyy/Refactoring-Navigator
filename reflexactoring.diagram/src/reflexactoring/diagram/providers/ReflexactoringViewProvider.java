 ...
 * @generated
 */
public class ReflexactoringViewProvider extends AbstractProvider implements
		IViewProvider {
	...
	protected boolean provides(CreateDiagramViewOperation op) {
		return ReflexactoringEditPart.MODEL_ID.equals(op.getSemanticHint())
	...
	protected boolean provides(CreateNodeViewOperation op) {
		...
		if (op.getSemanticHint() == null) {
			...
			visualID = ReflexactoringVisualIDRegistry.getNodeVisualID(
					op.getContainerView(), domainElement);
		} else {
			visualID = ReflexactoringVisualIDRegistry.getVisualID(op
					.getSemanticHint());
			if (elementType != null) {
				if (!ReflexactoringElementTypes.isKnownElementType(elementType)
				...
				if (domainElement != null
						&& visualID != ReflexactoringVisualIDRegistry
								.getNodeVisualID(op.getContainerView(),
										domainElement)) {
					return false; // visual id for node EClass should match visual id from element type
				}
			} else {
				if (!ReflexactoringEditPart.MODEL_ID
						.equals(ReflexactoringVisualIDRegistry.getModelID(op
								.getContainerView()))) {
	...
	protected boolean provides(CreateEdgeViewOperation op) {
		...
		int visualID = ReflexactoringVisualIDRegistry
	...
	public Diagram createDiagram(IAdaptable semanticAdapter,
		...
		diagram.setType(ReflexactoringEditPart.MODEL_ID);
	...
	public Node createNode(IAdaptable semanticAdapter, View containerView,
		...
		if (semanticHint == null) {
			...
			visualID = ReflexactoringVisualIDRegistry.getVisualID(semanticHint);
		}
		switch (visualID) {
		case ClassEditPart.VISUAL_ID:
		...
		case InterfaceEditPart.VISUAL_ID:
			return createInterface_2002(domainElement, containerView, index,
					persisted, preferencesHint);
		case ModuleEditPart.VISUAL_ID:
			return createModule_2003(domainElement, containerView, index,
					persisted, preferencesHint);
		case Class2EditPart.VISUAL_ID:
			return createClass_3001(domainElement, containerView, index,
					persisted, preferencesHint);
		case Interface2EditPart.VISUAL_ID:
			return createInterface_3002(domainElement, containerView, index,
					persisted, preferencesHint);
		}
	...
	public Edge createEdge(IAdaptable semanticAdapter, View containerView,
		...
		String elementTypeHint = ((IHintedType) elementType).getSemanticHint();
		switch (ReflexactoringVisualIDRegistry.getVisualID(elementTypeHint)) {
		case ModuleDependencyEditPart.VISUAL_ID:
			return createModuleDependency_4001(
					getSemanticElement(semanticAdapter), containerView, index,
					persisted, preferencesHint);
		case ModuleExtendEditPart.VISUAL_ID:
			return createModuleExtend_4006(getSemanticElement(semanticAdapter),
					containerView, index, persisted, preferencesHint);
		case ClassExtendEditPart.VISUAL_ID:
			return createClassExtend_4002(getSemanticElement(semanticAdapter),
					containerView, index, persisted, preferencesHint);
		case TypeDependencyEditPart.VISUAL_ID:
			return createTypeDependency_4003(
					getSemanticElement(semanticAdapter), containerView, index,
					persisted, preferencesHint);
		case InterfaceExtendEditPart.VISUAL_ID:
			return createInterfaceExtend_4004(
					getSemanticElement(semanticAdapter), containerView, index,
					persisted, preferencesHint);
		case ImplementEditPart.VISUAL_ID:
			return createImplement_4005(getSemanticElement(semanticAdapter),
					containerView, index, persisted, preferencesHint);
		case ModuleCreationEditPart.VISUAL_ID:
			return createModuleCreation_4007(
					getSemanticElement(semanticAdapter), containerView, index,
					persisted, preferencesHint);
		}
	...
	public Node createClass_2001(EObject domainElement, View containerView,
		...
		node.setType(ReflexactoringVisualIDRegistry
	 ...
	 * @generated
	 */
	public Node createInterface_2002(EObject domainElement, View containerView,
			int index, boolean persisted, PreferencesHint preferencesHint) {
		Node node = NotationFactory.eINSTANCE.createNode();
		node.getStyles()
				.add(NotationFactory.eINSTANCE.createDescriptionStyle());
	 ...
	 * @generated
	 */
	public Node createModule_2003(EObject domainElement, View containerView,
			int index, boolean persisted, PreferencesHint preferencesHint) {
		Node node = NotationFactory.eINSTANCE.createNode();
		node.getStyles()
				.add(NotationFactory.eINSTANCE.createDescriptionStyle());
	 ...
	 * @generated
	 */
	public Node createClass_3001(EObject domainElement, View containerView,
			int index, boolean persisted, PreferencesHint preferencesHint) {
		Node node = NotationFactory.eINSTANCE.createNode();
		node.getStyles()
				.add(NotationFactory.eINSTANCE.createDescriptionStyle());
	 ...
	 * @generated
	 */
	public Node createInterface_3002(EObject domainElement, View containerView,
			int index, boolean persisted, PreferencesHint preferencesHint) {
		Node node = NotationFactory.eINSTANCE.createNode();
		node.getStyles()
				.add(NotationFactory.eINSTANCE.createDescriptionStyle());
	 ...
	 * @generated
	 */
	public Edge createModuleDependency_4001(EObject domainElement,
		...
		edge.setType(ReflexactoringVisualIDRegistry
	 ...
	 * @generated
	 */
	public Edge createModuleExtend_4006(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Edge edge = NotationFactory.eINSTANCE.createEdge();
		edge.getStyles().add(NotationFactory.eINSTANCE.createRoutingStyle());
	 ...
	 * @generated
	 */
	public Edge createClassExtend_4002(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
	 ...
	 * @generated
	 */
	public Edge createTypeDependency_4003(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Connector edge = NotationFactory.eINSTANCE.createConnector();
		edge.getStyles().add(NotationFactory.eINSTANCE.createFontStyle());
	 ...
	 * @generated
	 */
	public Edge createInterfaceExtend_4004(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Connector edge = NotationFactory.eINSTANCE.createConnector();
		edge.getStyles().add(NotationFactory.eINSTANCE.createFontStyle());
	 ...
	 * @generated
	 */
	public Edge createImplement_4005(EObject domainElement, View containerView,
			int index, boolean persisted, PreferencesHint preferencesHint) {
		Connector edge = NotationFactory.eINSTANCE.createConnector();
		edge.getStyles().add(NotationFactory.eINSTANCE.createFontStyle());
		RelativeBendpoints bendpoints = NotationFactory.eINSTANCE
	 ...
	 * @generated
	 */
	public Edge createModuleCreation_4007(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Edge edge = NotationFactory.eINSTANCE.createEdge();
		edge.getStyles().add(NotationFactory.eINSTANCE.createRoutingStyle());
	...
	private void stampShortcut(View containerView, Node target) {
		if (!ReflexactoringEditPart.MODEL_ID
				.equals(ReflexactoringVisualIDRegistry
						.getModelID(containerView))) {
			EAnnotation shortcutAnnotation = EcoreFactory.eINSTANCE
					.createEAnnotation();
			shortcutAnnotation.setSource("Shortcut"); //$NON-NLS-1$
			shortcutAnnotation.getDetails().put(
					"modelID", ReflexactoringEditPart.MODEL_ID); //$NON-NLS-1$
