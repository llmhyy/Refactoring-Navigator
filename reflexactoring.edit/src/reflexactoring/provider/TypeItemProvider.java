...
/**
 * This is the item provider adapter for a {@link reflexactoring.Type} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ReflexactoringPackage.Literals.TYPE__NAME,
				 true,
				 false,
				 false,
	...
	protected void addPackageNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Type_packageName_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Type_packageName_feature", "_UI_Type_type"),
				 ReflexactoringPackage.Literals.TYPE__PACKAGE_NAME,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
